...
public:
    ...
    static void LineSearch(Foo& f, Scalar& fx, Vector& x, Vector& grad, Matrix& Hessian,
                           Scalar& step,
                           ...
                           const LBFGSParam<Scalar>& param)
    {
       ...
       // std::cout << dg_init << "projection valu dg_int" <<std::endl;
        ...
        for(iter = 0; iter < param.max_linesearch; iter++)
        {
            ...
            fx = f(x, grad, Hessian);
           // std::cout << fx<<"fx 0n linesreach after x update in line search" << std::endl;
           // std::cout << fx_init + step * test_decr<< "fx+steo*dir pn line search" << std::endl;
        ...
        //if(iter >= param.max_linesearch)
            ...
            //std::cout <<  "the line search routine reached the maximum number of iterations" << std::endl;
    }
};
