function DDi = get_reduction_localMatrix2(Node_globalIndex,sizeX)
     ...
     Colum = [Ng(1),Ng(4),Ng(1),Ng(7),Ng(1),Ng(10),...
              Ng(2),Ng(5),Ng(2),Ng(8),Ng(2),Ng(11),...
              Ng(3),Ng(6),Ng(3),Ng(9),Ng(3),Ng(12)];
